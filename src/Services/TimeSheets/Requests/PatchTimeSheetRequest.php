...
class PatchTimeSheetRequest implements PatchRequest, WithPathParams, WithRequestBodyParam
{
    use TimeSheetsEndpoint, ExecutesRequests, HasPathParams, HasRequestBodyParam;

...
class GetShippingMethodsRequest implements PostRequest, WithRequestBodyParam
{
    use OrdersEndpoint, ExecutesRequests, HasRequestBodyParam;

    public function __construct(
        #[RequestBodyParam]
        public ShippingMethodRequestData $request
    ){
        $this->setEndpoint();
    }
    ...
    {
        $this->endpoint = $this::ENDPOINT_BASE . '/shippingMethods';
    }
}

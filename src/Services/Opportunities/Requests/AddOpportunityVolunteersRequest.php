...
class AddOpportunityVolunteersRequest implements PostRequest, WithPathParams, WithRequestBodyParam
{
    ...
    public function __construct(
        ...
        public string $id,
        #[RequestBodyParam]
        public AssignmentVolunteersData $volunteers
    ){
        $this->setEndpoint();
    }
    ...
    {
        $this->endpoint = $this::ENDPOINT_BASE . '/{id}/addVolunteers';
    }
}

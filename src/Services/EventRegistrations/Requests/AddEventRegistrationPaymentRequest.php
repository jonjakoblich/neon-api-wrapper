...
class AddEventRegistrationPaymentRequest implements PostRequest, WithPathParams, WithRequestBodyParam
{
    ...
    {
        $this->endpoint = $this::ENDPOINT_BASE . '/{registrationId}/payments';
    }
}

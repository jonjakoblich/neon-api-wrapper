...
class UpdateHouseholdRequest implements PutRequest, WithPathParams, WithRequestBodyParam
{
    use HouseholdsEndpoint, ExecutesRequests, HasPathParams, HasRequestBodyParam;
